  ...
  paths: {
    ...
    "/student/feedback": {
      post: {
        ...
        responses: {
          "201": { description: "Feedback created successfully and sent to admin portal." }
        }
      },
      get: {
        tags: ["Feedback"],
        summary: "Get student submitted feedbacks",
        responses: { "200": { description: "Returns list of submitted feedbacks" } }
      }
    },
    "/admin/feedback": {
      get: {
        ...
        responses: { "200": { description: "List of student feedbacks for admin review" } }
      }
    },
    "/admin/companies": {
      get: {
        ...
        responses: { "200": { description: "Returns list of authorized partner companies" } }
      }
    },
    "/admin/companies/access": {
      post: {
        ...
        responses: { "201": { description: "Company portal access granted successfully." } }
      }
    },
    "/admin/companies/{id}/access": {
      patch: {
        ...
        responses: { "200": { description: "Company access state updated." } }
      }
    },
    "/roadmap/curriculum": {
      get: {
